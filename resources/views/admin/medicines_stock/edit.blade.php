					...
					<div class="card-body">
						...
						<form action="{{ url('admin/medicines_stock/edit/'.$oldRecord->id) }}" method="post" enctype="multipart/form-data">
							...
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									<input type="text" value="{{ $oldRecord->batch_id }}"  name="batch_id"
							...
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									<input type="date" value="{{ $oldRecord->expiry_date }}"  name="expiry_date"
									class="form-control" required>
								</div>
							</div>
							...
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									<input type="text" value="{{ $oldRecord->quantity }}"  name="quantity"
									class="form-control" required>
								</div>
							</div>
							...
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									<input type="text" value="{{ $oldRecord->mrp }}"  name="mrp"
									class="form-control" required>
								</div>
							</div>
							...
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									<input type="text" value="{{ $oldRecord->rate }}"  name="rate"
									class="form-control" required>
								</div>
							</div>
