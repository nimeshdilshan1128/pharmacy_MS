					...
					<div class="card-body">
						...
						<form action="{{ url('admin/invoices/add') }}" method="post" enctype="multipart/form-data">
							...
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									<input type="text" value="{{ old('net_total') }}"  name="net_total"
							...
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									<input type="date" value=""  name="invoices_date"
									class="form-control" required>
								</div>
							</div>
							...
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									<input type="text" value="{{ old('total_amount') }}"  name="total_amount"
									class="form-control" required>
								</div>
							</div>
							...
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									<input type="text" value="{{ old('total_discount') }}"  name="total_discount"
									class="form-control" required>
								</div>
							</div>
